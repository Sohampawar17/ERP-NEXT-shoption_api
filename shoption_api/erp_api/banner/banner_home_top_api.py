...
def get_home_banner_top(page=1, page_size=20):
    api_auth()
    require_post()
    ...
    try:
        ...
        return api_response(True, "Home Banner Top fetched", response)

    except Exception:
        return api_response(True, "Home Banner Top fetched", {
            "total": 0,
            "page": page,
            "page_size": page_size,
            "total_pages": 0,
