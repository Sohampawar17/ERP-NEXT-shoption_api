...
def get_trending_in_area(page=1, page_size=20, mobile_no=None):
    api_auth()
    require_post()
    ...
    try:
        ...
        # 9) Pagination Meta
        # ----------------------------
        total = frappe.db.count("Trending In Area")
        total_pages = (total + page_size - 1) // page_size

        return api_response(True, "Trending In Area fetched", {
            "total": total,
            "page": page,
            "page_size": page_size,
